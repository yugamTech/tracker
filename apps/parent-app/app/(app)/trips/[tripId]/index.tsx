...
const styles = StyleSheet.create({
  ...
  banner: { backgroundColor: '#0EA5E9', padding: spacing[5] },
  ...
  bannerBadge: { marginTop: spacing[2] },
  sectionLabel: {
  ...
  replayBtnText: { fontSize: fontSizes.base, color: '#0EA5E9', fontWeight: fontWeights.semibold },
});
