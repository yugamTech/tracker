...
const styles = StyleSheet.create({
  ...
  logoBox: { width: 72, height: 72, borderRadius: radius.xl, backgroundColor: '#0EA5E9', alignItems: 'center', justifyContent: 'center' },
  title: { fontSize: fontSizes['2xl'], fontWeight: fontWeights.extrabold, color: '#0EA5E9' },
  ...
  inputRow: { flexDirection: 'row', borderWidth: 1.5, borderColor: colors.border, borderRadius: radius.lg, overflow: 'hidden', backgroundColor: colors.gray50 },
